...
이름을 치면 박스가 맞는 아이만 보여줍니다. 폼·지방 접두사까지 같이 걸려서 <b>갈라르</b>만 쳐도 그 무리가 다 나오고, 번호로도 찾을 수 있어요. <b>초성</b>도 됩니다 — <b>ㄴㅇ</b> 로 나옹이 나와요. 질의가 전부 자음일 때만 초성 모드라, 글자를 치는 도중에도 평소대로 찾아집니다. 검색은 보기만 거르고 박스를 재배치하지 않으며, 질의를 바꾸면 담아 둔 선택이 비워져요 — 보이는 것이 곧 보낼 것이어야 하니까요.
</td>
