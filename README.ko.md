...
<td width="55%" valign="middle">
<h3>✅ 홈에서 하루 세 가지</h3>
부화 슬롯 아래에 하루면 사라지는 목표 셋이 있어요 — 알 뽑기, 부화시키기, 진화시키기, 박사에게 보내기, 제안 열어 보기. 보상은 재화가 아니라 <b>박사 포인트</b>예요. 포인트로는 알을 못 사고 토큰으로는 포인트를 못 사서, 매일 하는 일이 상점을 앞지르지 않아요. 셋을 다 받으면 경험치 사탕 하나가 덤으로 한 번. 셋은 그날 날짜와 <b>내 세이브만의 시드</b>로 굴려서 모두의 것이 아니라 내 것이고, 어떤 목표도 하루치 수입보다 많이 쓰라고 하지 않아요.
</td>
<td width="45%" align="center"><img src="assets/daily-goals.png" width="300" alt="홈 탭의 오늘의 목표 — 하나는 받았고, 하나는 받을 수 있고, 하나는 진행 중"></td>
</tr>
<tr>
