...
<tr>
<td width="45%" align="center"><img src="assets/draw-slot.png" width="300" alt="부화칸의 세 상태 — 10M 이 적힌 초록 뽑기 칸, 지갑이 모자라 회색이 된 같은 칸, 자리가 다 차서 칸이 아예 없는 줄"></td>
<td width="55%" valign="middle">
<h3>🥚 알이 떨어지는 자리에서 뽑아요</h3>
빈 칸이 곧 버튼이에요. 부화칸의 첫 빈 자리에 값이 적혀 있고 누르면 거기서 뽑혀요 — 쓰는 것과 얻는 것이 같은 자리에 있는 셈이죠. 재화가 빈 칸 수와 한 줄에 있어서, 칸이 회색일 때 지갑 때문인지 자리 때문인지 바로 가려집니다. 확률은 칸 아래에 적히고, 도감 미션에서 받은 알 확정권도 그 자리에 서요 — 개봉은 언제나 알이 태어나는 자리에서 일어나야 하니까요.
</td>
</tr>
<tr>
<td width="55%" valign="middle">
