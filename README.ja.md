...
<tr>
<td width="45%" align="center"><img src="assets/draw-slot.png" width="300" alt="ふ化スロットの3つの状態 — 10M と書かれた緑の抽選マス、所持金が足りず灰色になった同じマス、空きがなくマス自体がない列"></td>
<td width="55%" valign="middle">
<h3>🥚 タマゴが落ちる場所で引きます</h3>
空きマスがそのままボタンです。ふ化スロットの最初の空きに値段が書かれ、押すとそこで引けます — 使うものと得るものが同じ場所にあるわけです。所持金が空き数と同じ行にあるので、マスが灰色のときに所持金のせいか空きのせいかがすぐ分かります。確率はマスの下に、ずかんミッションでもらったタマゴかくていけんもその場に並びます — ひらく瞬間はいつもタマゴが生まれる場所であるべきだからです。
</td>
</tr>
<tr>
<td width="55%" valign="middle">
