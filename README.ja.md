...
<td width="45%" align="center"><img src="assets/daily-goals.png" width="300" alt="はかせの いらい — ひとつは受けとり、ひとつは受けとれ、ひとつは進行中"></td>
</tr>
<tr>
...
ミッションの隣にテーマ別セットが32個 — でんせつの鳥、クローンの真実（ミュウ・ミュウツー・メタモン）、イーブイフレンズ、六世代ぶんのカセキ全部、こだいとみらいのパラドックス、<b>ぜんせだいの さいしょのポケモン</b>、そして動物でまとめた4つ — サル・ネコ・イヌ、そして地方ごとに最初のルートで待っているまちの鳥まで。メンバーは常にシルエットで見えるので、何が足りないかひと目でわかります。セットを完成させると行にメダルが灯り、ほうびを一度もらえます — 多くはけいけんちアメ、大きなセットはでんせつタマゴかくていけん。レジファミリーは特別です: 五本の柱を集めると<b>レジギガスそのものが目覚めて</b>ボックスに加わります — タマゴからは決して生まれない、このセットだけのほうびで、ひかる確率もいつも通り回ります。
</td>
</tr>
<tr>
<td width="55%" valign="middle">
