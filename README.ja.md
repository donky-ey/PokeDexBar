...
3. 🥚 **タマゴを引く。** ホームの**ふ化スロットの列**で通貨を払うと、等級がランダムに決まったタマゴがもらえます — コモン60%・レア22%・エピック16%・レジェンダリー2%、選ぶことはできません。引いた瞬間、短い演出がまず流れます — 白い炸裂は必ず起き、レアなら水色がもう一段、エピックなら紫がもう一段、レジェンダリーならきらめくオレンジまでもう一段 — 何回はじけたかがそのまま等級なので、結果の文字を見る前にわかります。最大3個まで同時に温められ、スロットを買えば6個まで拡張できます。
...
<td width="55%" valign="middle">
<h3>🔎 めくって探さなくていい</h3>
なまえを打つと、まだ開いていないページも含めてボックス全体から探します。なまえの読み込みが完了すると一致するポケモンが表示され、検索語を変えると結果の最初のページに戻ります。フォームや地方のかんむりも一緒にかかるので<b>ガラル</b>だけでその一群が出てきますし、ずかんばんごうでも探せます。ハングルの初声にも対応しています。検索は見え方をしぼるだけでボックスを並べ替えず、クエリを変えるとまとめて選んだぶんは解除されます — 見えているものが送るものであるように。
</td>
<td width="45%" align="center"><img src="assets/box-search.png" width="300" alt="同じボックスを2回検索した様子 — 初声で、そしてなまえの一部で"></td>
</tr>
<td width="55%" valign="middle">
...
<td width="55%" valign="middle">
<h3>🎯 ずかんが応えてくれる</h3>
ずかん集めにミッションがつきました — 本家の構造そのまま: 登録数の節目(10種から1000種まで)ごとにほうび、世代をひとつ完成させると<b>でんせつタマゴかくていけん</b>にその世代の代表アイテム(メガシンカ世代はメガストーン、カントー・ガラルはダイマックスキノコ、のこりはひかるアメ)、そして1025種すべてをうめると<b>にじいろおまもり</b> — それだけでひかる確率が1/32になり、もとのおまもりがなくてももらえます。そのあとひかるおまもりをどのだんかいまで上げても、確率をもう一段よくしてくれます。かくていけんはバッグに入り、ふ化スロットの下で無料・等級かくていの抽選としてつかえます。
</td>
<td width="45%" align="center"><img src="assets/screenshot-dex-missions.png" width="300" alt="ずかんタブのミッション一覧 — 節目へのゲージと、うけとれる3行"></td>
</tr>
<tr>
<td width="55%" valign="middle">
<h3>✅ はかせが 1日3つ たのみます</h3>
はかせのていあんのすぐ下に、1日で消える いらいが3つ — タマゴを引く、かえす、しんかさせる、はかせにおくる。ほうびは所持金ではなく<b>はかせポイント</b>です。ポイントでタマゴは買えず、トークンでポイントも買えないので、毎日のしゅうかんがショップを追いこしません。3つとも受けとると、けいけんちアメが1個だけおまけに。3つはその日の日付と<b>セーブごとのシード</b>で決まるので、みんなのものではなく自分のもので、どのいらいも1日ぶんの収入より多くを求めません。
</td>
<td width="45%" align="center"><img src="assets/professor-requests.png" width="300" alt="はかせの いらい — ひとつは受けとり、ひとつは受けとれ、ひとつは進行中"></td>
</tr>
<tr>
...
ミッションの隣にテーマ別セットが45個 — でんせつの鳥、クローンの真実（ミュウ・ミュウツー・メタモン）、イーブイフレンズ、六世代ぶんのカセキ全部、こだいとみらいのパラドックス、<b>ぜんせだいの さいしょのポケモン</b>、動物でまとめた4つ（サル・ネコ・イヌ・まちの鳥）、そして<b>でんせつとまぼろし すべて</b>に居場所ができました — せいけんし・しまのまもりがみから、わざわいのポケモンとキタカミのいいつたえまで。メンバーは常にシルエットで見えるので、何が足りないかひと目でわかります。セットを完成させると行にメダルが灯り、ほうびを一度もらえます — 多くはけいけんちアメ、大きなセットはでんせつタマゴかくていけん。レジファミリーは特別です: 五本の柱を集めると<b>レジギガスそのものが目覚めて</b>ボックスに加わります — タマゴからは決して生まれない、このセットだけのほうびで、ひかる確率もいつも通り回ります。
</td>
</tr>
<tr>
<td width="55%" valign="middle">
...
<td width="55%" valign="middle">
<h3>🍂 こよみと空を感じる子たち</h3>
<b>シキジカ</b>と<b>メブキジカ</b>は原作どおり季節をまといます — しかも本物の今月なので、見ていないあいだに毛並みが変わっています。半球は Mac の地域が決めるので、オーストラリアのメブキジカはクリスマスに夏すがたです。<b>ポワルン</b>と<b>チェリム</b>は、いまそこの実際の天気を読みます。太陽・雨・雪にそれぞれのすがたがあり、チェリムは本物の日ざしにだけ開きます — 晴れた夜は閉じたままです。求めるものはありません: 位置情報の許可もアカウントも不要で、この4ひきがボックスにいなければリクエスト自体が出ません。
</td>
<td width="45%" align="center"><img src="assets/season-forms.png" width="300" alt="シキジカとメブキジカの春・夏・秋・冬すがた"></td>
</tr>
<tr>
<td width="45%" align="center"><img src="assets/weather-forms.png" width="300" alt="ポワルンのノーマル・たいよう・あまみず・ゆきぐもすがたと、晴れのときだけ開くチェリム"></td>
<td width="55%" valign="middle">
<h3>☀️ どこに住んでいるか聞かない天気</h3>
空は位置情報ではなくシステムのタイムゾーンから来ます。`Asia/Seoul` ならソウルで、雨が降っているかどうかにはそれで十分です。実際の位置は読みも送りもしません。ネットワークがなければ最後の空をそのままにし、そもそも取れたことがなければチェリムはこれまでどおり自分の確率で咲きます。
</td>
</tr>
<tr>
...
<tr>
<td width="45%" align="center"><img src="assets/draw-slot.png" width="300" alt="ふ化スロットの3つの状態 — タマゴの隣に立つ10Mの抽選マス、所持金が足りず暗くなった同じマス、空きがなく暗いまま列の下に「ふ化スロットがいっぱいです」と出た状態"></td>
<td width="55%" valign="middle">
<h3>🥚 タマゴが落ちる場所で引きます</h3>
「引く」と書かれたマスがふ化スロットの列の先頭に立ちます — 使うものと得るものが同じ場所にあるわけです。このマスは固定で、タマゴが埋まってもずれず、スクロールでも消えないので、ポインタを動かさずに続けて引けます。所持金が空き数と同じ行にあるので、マスが暗いときに所持金のせいか空きのせいかがすぐ分かり、空きがないときは列の下が確率ではなくその事実を伝えます。ずかんミッションでもらったタマゴかくていけんもその場に並びます — ひらく瞬間はいつもタマゴが生まれる場所であるべきだからです。
</td>
</tr>
<tr>
...
<td width="55%" valign="middle">
<h3>🛒 経済のためのショップ</h3>
これまで使ったトークンがそのまま通貨です — ふ化スロットを3個から6個まで拡張し、<b>けいけんちアメ</b> でポケモンを育てたり <b>ひかるアメ</b> でそのまま色違いにしたりできます。おまもり3つ — 孵化の色違い確率を上げる <b>ひかるおまもり</b>、トークンとアメで得られる経験値を上げる <b>けいけんちおまもり</b>、トークンで得られる所持金を上げる <b>こううんのおまもり</b> — は一度買って終わりではなく、だんかいを上げていくものになりました。個体の詳細画面から <b>メガストーン</b> や <b>ダイマックスウキノコ</b> を使うと、80種類のフォームのひとつに姿を変えられます。進化の道具とフォルムの道具は意図的に売っていません — それはパートナーがもってきます。
</td>
</tr>
<tr>
<td width="55%" valign="middle">
<h3>🪜 おまもりは買い切りではなく、はしご</h3>
おまもりには上げつづけられるだんかいがあります。値段は一段ごとに2倍になるのに効果は一定ずつ増えるので、得ひとつあたりの費用が毎段2倍になります — 上限を置いていないのは、値段そのものが上限だからです。各行は「何を上げるのか・今いくつか・次のだんかいならいくつか」を一緒に伝えます。すでに買った人は払った分の効果をそのまま持っていけます: これまでの買い切りのおまもりは4だんかいに置かれ、それは経験値2.00倍・所持金1.50倍・色違い1/48 — 以前と同じ数字です。
</td>
<td width="45%" align="center"><img src="assets/charm-ladder.png" width="300" alt="同じけいけんちおまもりの3だんかい — 未所持250M、4だんかい4Bで2.00倍、8だんかい64Bで3.00倍"></td>
</tr>
<tr>
<td width="55%" valign="middle">
...
<td width="55%" valign="middle">
<h3>🎒 集めたものを見るバッグ</h3>
ショップが売るのは7種類だけ。残り105種はパートナーがもってくる以外に手に入らないので、持ち物を見る場所が <b>バッグ</b> です — しょうひんアイテムは個数つき、おまもりは今のだんかいと効果つき、そして <b>進化の道具41種</b>・<b>フォルムの道具64種</b> はどこまで集めたかを進捗で見せます。ここでは使いません: どの道具も特定のポケモンに使うものなので、そのポケモンの詳細画面で使います。
</td>
</tr>
</table>
...
v1.18.2 以降の公式リリースは Developer ID で署名し、Apple の公証を受けています。Homebrew はダウンロードのチェックサムを検証し、macOS のセキュリティチェックを維持します。
...
アプリを通常どおり開いてください。公証済みのリリースでは、隔離属性の削除や Gatekeeper の例外設定は不要です。
...
swift build                  # デバッグ
swift test                   # ユニットテスト
./scripts/build-app.sh       # ローカルのリリースビルド → build/PokeDexBar.app
```
